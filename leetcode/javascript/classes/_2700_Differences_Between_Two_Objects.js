...
function objDiff(obj1, obj2) {
    ...
    for (const key in obj1) {
        //hasOwnProperty check for the own properties on an object
        //whereas "in" would also include the inherited ones.
        //But note that "in" when used ina loop context will iterate over the enumerable properties
