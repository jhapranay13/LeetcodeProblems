...
public class _1788_Maximize_the_Beauty_of_the_Garden {
    public int maximumBeauty(int[] flowers) {
        ...
        for (int i = 0; i < flowers.length; i++) {
            ...
            if (sumHolder.containsKey(flower)) {
                ans = Math.max(ans, sum - sumHolder.get(flower) + 2 * flower);
            }
