 ...
 *             /|\        //\       \
 *           /  |  \    //    \       \
 *     ____/____|____\//________\_______\__________________________________________
 *              0     1    2     3   4   5      6
 *
...
public class _2237_Count_Positions_on_Street_With_Required_Brightness {
    public int meetRequirement(int n, int[][] lights, int[] requirement) {
        ...
        for (int[] light : lights) {
            int pos = light[0];
            int radius = light[1];
            int start = pos - radius >= 0 ? pos - radius : 0;
            int end = pos + radius >= n ? n : pos + radius + 1;
            lineSweep[start]++;
            lineSweep[end]--;
        }
