 ...
 *         where (x1, y1) is the coordinate of its bottom-left corner, and (x2,
 *         y2) is the coordinate of its top-right corner. Its top and bottom
 *         edges are parallel to the X-axis, and its left and right edges are
 ...
 *         Constraints:
 * 
 *         rect1.length == 4 rect2.length == 4 -109 <= rec1[i], rec2[i] <= 109
