 ...
 *         Note:
 * 
 *         The length of words will be at most 100. Each words[i] will have
 *         length in range [1, 12]. words[i] will only consist of lowercase
 *         letters.
 *
 */
...
public class _804_UniqueMorseCodeWords {
	...
	public int uniqueMorseRepresentations(String[] words) {
		Set<String> tranformations = new HashSet<>();
		String[] morseCodes = { ".-", "-...", "-.-.", "-..", ".", "..-.", "--.", "....", "..", ".---", "-.-", ".-..",
				"--", "-.", "---", ".--.", "--.-", ".-.", "...", "-", "..-", "...-", ".--", "-..-", "-.--", "--.." };
		...
		for (String word : words) {
			...
			for (char ch : word.toCharArray()) {
				transform.append(morseCodes[ch - 'a']);
			}
			tranformations.add(transform.toString());
		}
		return tranformations.size();
	}
}
