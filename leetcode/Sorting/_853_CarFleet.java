...
public class _853_CarFleet {
    ...
    public int carFleet(int target, int[] position, int[] speed) {
        ...
        while (!pq.isEmpty()) {
            int[] positionAndSpeed = pq.poll();
            double timeTaken = (double)(target - positionAndSpeed[0]) / positionAndSpeed[1];

            //number of fleet will increase as current car will never be able to catch up to the previous car
