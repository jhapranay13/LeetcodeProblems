 ...
 *         class:
 * 
 *         MedianFinder() initializes the MedianFinder object. void addNum(int
 ...
 *         "findMedian"] [[], [1], [2], [], [3], []] Output [null, null, null,
 *         1.5, null, 2.0]
 * 
 *         Explanation MedianFinder medianFinder = new MedianFinder();
 *         medianFinder.addNum(1); // arr = [1] medianFinder.addNum(2); // arr =
 *         [1, 2] medianFinder.findMedian(); // return 1.5 (i.e., (1 + 2) / 2)
 ...
 *         structure before calling findMedian. At most 5 * 104 calls will be
 *         made to addNum and findMedian.
 * 
 * 
 *         Follow up:
 * 
 *         If all integer numbers from the stream are in the range [0, 100], how
 *         would you optimize your solution? If 99% of all integer numbers from
 *         the stream are in the range [0, 100], how would you optimize your
 *         solution?
 *
 */
