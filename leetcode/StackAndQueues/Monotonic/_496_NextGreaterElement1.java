 ...
 *         follows: - 4 is underlined in nums2 = [1,3,4,2]. There is no next
 *         greater element, so the answer is -1. - 1 is underlined in nums2 =
 *         [1,3,4,2]. The next greater element is 3. - 2 is underlined in nums2
 *         = [1,3,4,2]. There is no next greater element, so the answer is -1.
 *         
 *         
 *         Example 2:
 * 
 *         Input: nums1 = [2,4], nums2 = [1,2,3,4] Output: [3,-1] Explanation:
 *         The next greater element for each value of nums1 is as follows: - 2
 *         is underlined in nums2 = [1,2,3,4]. The next greater element is 3. -
 ...
 *         104 All integers in nums1 and nums2 are unique. All the integers of
...
public class _496_NextGreaterElement1 {
	...
	public int[] nextGreaterElement(int[] nums1, int[] nums2) {
        ...
        for (int num : nums1) {
            ans[index++] = nextGreaterMap.getOrDefault(num, -1);    
        }
        return ans;
    }
}
